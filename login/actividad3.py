...
frame_izquierda = tk.Frame(ventana, width=200, height=400, bg="beige")
...
logo_label = tk.Label(frame_izquierda, text="Logo", font=("CALIBRI", 50), bg="beige")
...
clave_entry = tk.Entry(frame_derecha, show="*", font=("Arial", 13)) # El parámetro show="*" oculta los caracteres de la contraseña
clave_entry.pack()
